...
class WeiboLogin:
    ...
    def Login(self):
        ...
        try:
            ...
            result_text = urllib2.urlopen(loginUrl)  ## 这个地方因为需要验证码验证了 所以返回的信息告诉你需要验证码
        except:
            print 'Login error!'
            return False
    ...
    def EnableCookie(self, enableProxy):
        ...
        if enableProxy:
            proxy_support = urllib2.ProxyHandler({'http':'http://nihao.pac'})#使用代理
...
if __name__ == '__main__':
    weiboLogin = WeiboLogin('xxx', 'xxx') #邮箱（账号）、密码
